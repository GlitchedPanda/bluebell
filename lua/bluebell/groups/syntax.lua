...
function M.get()
	return {
		...
		Function = { fg = C.mauve, style = O.styles.functions or {} }, -- function name (also: methods for classes)
		...
		Exception = { fg = C.blue, style = O.styles.keywords or {} }, --  try, catch, throw

		PreProc = { fg = C.pink }, -- (preferred) generic Preprocessor
		Include = { fg = C.blue, style = O.styles.keywords or {} }, --  preprocessor #include
		...
		qfFileName = { fg = C.mauve },
		htmlH1 = { fg = C.pink, style = { "bold" } },
		htmlH2 = { fg = C.mauve, style = { "bold" } },
		...
		DiffChange = { bg = U.darken(C.mauve, 0.07, C.base) }, -- diff mode: Changed line |diff.txt|
		DiffDelete = { bg = U.darken(C.red, 0.18, C.base) }, -- diff mode: Deleted line |diff.txt|
		DiffText = { bg = U.darken(C.mauve, 0.30, C.base) }, -- diff mode: Changed text within a changed line |diff.txt|
		-- NeoVim
